...
function efbpd_create_meta_box(){
	global $theme_name;
	add_meta_box('post-meta-boxes',__('Fan Page Settings'),'post_meta_boxes_efbpd','fanpages','side','low');
}

function efbpd_post_meta_boxes(){
	$meta_boxes=array(
		'background'=>array('name'=>'_EFBPDBgColor','title'=>__('BG Color','efbpd'),'type'=>'colortext'),
		'appid'=>array('name'=>'_EFBPDAppID','title'=>__('Your App ID','efbpd'),'type' =>'text')
	);
